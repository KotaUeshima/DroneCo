  ...
  const values = [
    {
      ...
      title: "Integrity",
      description:
        "Integrity and trust is a key component in the success of DroneCo and its success. Integrity and trust is a key component in the success of DroneCo and its success.",
    },
    {
      id: 2,
      title: "Integrity",
  ...
  return (
    <div className="min-h-screen w-full flex flex-row">
      ...
      <div className="w-full flex flex-col items-center pt-[10vh]">
        <h2 className="text-4xl">Why DroneCo?</h2>
