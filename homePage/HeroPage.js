  ...
  return (
    <div className="relative min-h-screen w-full bg-gray-100">
      ...
      <div className="h-[50vh] w-full flex flex-col justify-end items-center">
        <h2 className="relative z-10 text-center text-2xl md:text-4xl lg:text-6xl font-thin text-droneBlue">
          We're Building the Future of Last-Mile Delivery
        </h2>
        <p className="relative z-10 font-normal md:text-2xl italic text-droneBlue py-7 tracking-widest">
          Elevating <span className="text-droneOrange">mobility</span>, one
          drone at a time.
        </p>
      </div>
