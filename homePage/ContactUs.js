    ...
    <div className="relative min-h-screen w-full flex flex-row">
      ...
      <div className="mt-20 h-full w-[60vw] flex justify-center items-center">
        <form
          ...
          method="POST"
          className="flex flex-col w-2/3 bg-droneBlue px-20 pb-10"
        >
          ...
          <div className="flex flex-row space-x-4">
            <input
              ...
              className="p-2 bg-white border-2 w-1/2 text-black focus:outline-none"
            />
            <input
              type="text"
              name="lastName"
          ...
          <input
            ...
            name="email"
            placeholder="Email*"
            className="mt-4 p-2 bg-white border-2  text-black focus:outline-none"
          />
          <input
            type="text"
            name="companyName"
          ...
          <textarea
            ...
            className="mt-4 p-2 bg-white border-2  text-black focus:outline-none"
          ></textarea>
          <button className="mt-6 mx-auto bg-droneOrange hover:bg-transparent px-1 py-2 w-1/2  hover:text-white text-white border-[1px] hover:border-[1px] border-droneOrange hover:border-white duration-500">
            Submit
          </button>
        </form>
      </div>
